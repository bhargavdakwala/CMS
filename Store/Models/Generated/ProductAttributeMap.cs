...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Product_Attribute_Map table.
	/// </summary>
	[Serializable]
	public partial class ProductAttributeMap : ActiveRecord<ProductAttributeMap>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Product_Attribute_Map", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarAttributeId.DefaultSetting = @"";
					...
					colvarAttributeId.ForeignKeyTableName = "CMS_Store_Attribute";
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Product_Attribute_Map",schema);
			}
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.Attribute Attribute
		{
			get { return Etech.CMS.Store.Attribute.FetchByID(this.AttributeId); }
