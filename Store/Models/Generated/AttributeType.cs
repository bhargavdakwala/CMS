...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_AttributeType table.
	/// </summary>
	[Serializable]
	public partial class AttributeType : ActiveRecord<AttributeType>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_AttributeType", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_AttributeType",schema);
			}
		...
		public Etech.CMS.Store.AttributeCollection AttributeRecords()
		{
			return new Etech.CMS.Store.AttributeCollection().Where(Attribute.Columns.AttributeTypeId, AttributeTypeId).Load();
		}
