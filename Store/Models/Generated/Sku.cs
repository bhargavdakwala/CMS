...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Sku table.
	/// </summary>
	[Serializable]
	public partial class Sku : ActiveRecord<Sku>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Sku", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Sku",schema);
			}
