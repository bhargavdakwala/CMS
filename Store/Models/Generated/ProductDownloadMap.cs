...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Product_Download_Map table.
	/// </summary>
	[Serializable]
	public partial class ProductDownloadMap : ActiveRecord<ProductDownloadMap>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Product_Download_Map", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Product_Download_Map",schema);
			}
