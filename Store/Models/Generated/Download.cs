...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Download table.
	/// </summary>
	[Serializable]
	public partial class Download : ActiveRecord<Download>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Download", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Download",schema);
			}
		...
		public Etech.CMS.Store.DownloadAccessControlCollection DownloadAccessControlRecords()
		{
			return new Etech.CMS.Store.DownloadAccessControlCollection().Where(DownloadAccessControl.Columns.DownloadId, DownloadId).Load();
		}

		public Etech.CMS.Store.ProductDownloadMapCollection ProductDownloadMapRecords()
		{
			return new Etech.CMS.Store.ProductDownloadMapCollection().Where(ProductDownloadMap.Columns.DownloadId, DownloadId).Load();
		}
		...
		public Etech.CMS.Store.ProductCollection GetProductCollection() { return Download.GetProductCollection(this.DownloadId); }

		public static Etech.CMS.Store.ProductCollection GetProductCollection(int varDownloadId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Store_Product INNER JOIN CMS_Store_Product_Download_Map ON "+
				"CMS_Store_Product.ProductId=CMS_Store_Product_Download_Map.ProductId WHERE CMS_Store_Product_Download_Map.DownloadId=@DownloadId", Download.Schema.Provider.Name);
		...
		public static void SaveProductMap(int varDownloadId, ProductCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Store_Product_Download_Map WHERE DownloadId=@DownloadId", Download.Schema.Provider.Name);
