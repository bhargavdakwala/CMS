...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_OrderStatusDescriptor table.
	/// </summary>
	[Serializable]
	public partial class OrderStatusDescriptor : ActiveRecord<OrderStatusDescriptor>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_OrderStatusDescriptor", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_OrderStatusDescriptor",schema);
			}
		...
		public Etech.CMS.Store.OrderCollection OrderRecords()
		{
			return new Etech.CMS.Store.OrderCollection().Where(Order.Columns.OrderStatusDescriptorId, OrderStatusDescriptorId).Load();
		}
