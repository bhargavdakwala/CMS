...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_RegionCodeTaxRate table.
	/// </summary>
	[Serializable]
	public partial class RegionCodeTaxRate : ActiveRecord<RegionCodeTaxRate>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_RegionCodeTaxRate", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_RegionCodeTaxRate",schema);
			}
