...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Product table.
	/// </summary>
	[Serializable]
	public partial class Product : ActiveRecord<Product>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Product", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarManufacturerId.IsReadOnly = false;
					...
					colvarManufacturerId.ForeignKeyTableName = "CMS_Store_Manufacturer";
				...
				colvarProductStatusDescriptorId.IsReadOnly = false;
					...
					colvarProductStatusDescriptorId.ForeignKeyTableName = "CMS_Store_ProductStatusDescriptor";
				...
				colvarProductTypeId.IsReadOnly = false;
					...
					colvarProductTypeId.ForeignKeyTableName = "CMS_Store_ProductType";
				...
				colvarShippingEstimateId.IsReadOnly = false;
					...
					colvarShippingEstimateId.ForeignKeyTableName = "CMS_Store_ShippingEstimate";
                ...
                TableSchema.TableColumn colvarAllow = new TableSchema.TableColumn(schema);
                colvarAllow.ColumnName = "Allow";
                colvarAllow.DataType = DbType.String;
                colvarAllow.MaxLength = 150;
                ...
                colvarAllow.DefaultSetting = @"";
                colvarAllow.ForeignKeyTableName = "";
                schema.Columns.Add(colvarAllow);


                TableSchema.TableColumn colvarCarFrom = new TableSchema.TableColumn(schema);
                colvarCarFrom.ColumnName = "CarFrom";

                colvarCarFrom.DataType = DbType.String;
                colvarCarFrom.MaxLength = 50;

                colvarCarFrom.DataType = DbType.String;
                colvarCarFrom.MaxLength = 150;

                colvarCarFrom.AutoIncrement = false;
                colvarCarFrom.IsNullable = false;
                colvarCarFrom.IsPrimaryKey = false;
                colvarCarFrom.IsForeignKey = false;
                colvarCarFrom.IsReadOnly = false;
                colvarCarFrom.DefaultSetting = @"";
                colvarCarFrom.ForeignKeyTableName = "";
                schema.Columns.Add(colvarCarFrom);



                TableSchema.TableColumn colvarFourWDFrom = new TableSchema.TableColumn(schema);
                colvarFourWDFrom.ColumnName = "FourWDFrom";

                colvarFourWDFrom.DataType = DbType.String;
                colvarFourWDFrom.MaxLength = 50;

                colvarFourWDFrom.DataType = DbType.String;
                colvarFourWDFrom.MaxLength = 150;

                colvarFourWDFrom.AutoIncrement = false;
                colvarFourWDFrom.IsNullable = false;
                colvarFourWDFrom.IsPrimaryKey = false;
                colvarFourWDFrom.IsForeignKey = false;
                colvarFourWDFrom.IsReadOnly = false;
                colvarFourWDFrom.DefaultSetting = @"";
                colvarFourWDFrom.ForeignKeyTableName = "";
                schema.Columns.Add(colvarFourWDFrom);
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Product",schema);
			}
        ...
        public string Allow
        {
            get { return GetColumnValue<string>("Allow"); }

            set { SetColumnValue("Allow", value); }

        }
        [XmlAttribute("CarFrom")]


        public string CarFrom

        {
            get { return GetColumnValue<string>("CarFrom"); }

            set { SetColumnValue("CarFrom", value); }

        }
        [XmlAttribute("FourWDFrom")]


        public string FourWDFrom

        {

            get { return GetColumnValue<string >("FourWDFrom"); }



            set { SetColumnValue("FourWDFrom", value); }
		...
		public Etech.CMS.Store.CustomizedProductDisplayTypeProductMapCollection CustomizedProductDisplayTypeProductMapRecords()
		{
			return new Etech.CMS.Store.CustomizedProductDisplayTypeProductMapCollection().Where(CustomizedProductDisplayTypeProductMap.Columns.ProductId, ProductId).Load();
		}

		public Etech.CMS.Store.ImageCollection ImageRecords()
		{
			return new Etech.CMS.Store.ImageCollection().Where(Image.Columns.ProductId, ProductId).Load();
		}

		public Etech.CMS.Store.ProductCategoryMapCollection ProductCategoryMapRecords()
		{
			return new Etech.CMS.Store.ProductCategoryMapCollection().Where(ProductCategoryMap.Columns.ProductId, ProductId).Load();
		}

		public Etech.CMS.Store.CrossSellCollection CrossSellRecords()
		{
			return new Etech.CMS.Store.CrossSellCollection().Where(CrossSell.Columns.ProductId, ProductId).Load();
		}

		public Etech.CMS.Store.CrossSellCollection CrossSellRecordsFromProduct()
		{
			return new Etech.CMS.Store.CrossSellCollection().Where(CrossSell.Columns.CrossProductId, ProductId).Load();
		}

		public Etech.CMS.Store.ProductAttributeMapCollection ProductAttributeMapRecords()
		{
			return new Etech.CMS.Store.ProductAttributeMapCollection().Where(ProductAttributeMap.Columns.ProductId, ProductId).Load();
		}

		public Etech.CMS.Store.DescriptorCollection DescriptorRecords()
		{
			return new Etech.CMS.Store.DescriptorCollection().Where(Descriptor.Columns.ProductId, ProductId).Load();
		}

		public Etech.CMS.Store.ReviewCollection ReviewRecords()
		{
			return new Etech.CMS.Store.ReviewCollection().Where(Review.Columns.ProductId, ProductId).Load();
		}

		public Etech.CMS.Store.SkuCollection SkuRecords()
		{
			return new Etech.CMS.Store.SkuCollection().Where(Sku.Columns.ProductId, ProductId).Load();
		}
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.Manufacturer Manufacturer
		{
			get { return Etech.CMS.Store.Manufacturer.FetchByID(this.ManufacturerId); }
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.ProductStatusDescriptor ProductStatusDescriptor
		{
			get { return Etech.CMS.Store.ProductStatusDescriptor.FetchByID(this.ProductStatusDescriptorId); }
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.ProductType ProductType
		{
			get { return Etech.CMS.Store.ProductType.FetchByID(this.ProductTypeId); }
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.ShippingEstimate ShippingEstimate
		{
			get { return Etech.CMS.Store.ShippingEstimate.FetchByID(this.ShippingEstimateId); }
		...
		public Etech.CMS.Store.CategoryCollection GetCategoryCollection() { return Product.GetCategoryCollection(this.ProductId); }

		public static Etech.CMS.Store.CategoryCollection GetCategoryCollection(int varProductId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Store_Category INNER JOIN CMS_Store_Product_Category_Map ON "+
				"CMS_Store_Category.CategoryId=CMS_Store_Product_Category_Map.CategoryId WHERE CMS_Store_Product_Category_Map.ProductId=@ProductId", Product.Schema.Provider.Name);
		...
		public static void SaveCategoryMap(int varProductId, CategoryCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Store_Product_Category_Map WHERE ProductId=@ProductId", Product.Schema.Provider.Name);
		...
		public Etech.CMS.Store.AttributeCollection GetAttributeCollection() { return Product.GetAttributeCollection(this.ProductId); }

		public static Etech.CMS.Store.AttributeCollection GetAttributeCollection(int varProductId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Store_Attribute INNER JOIN CMS_Store_Product_Attribute_Map ON "+
				"CMS_Store_Attribute.AttributeId=CMS_Store_Product_Attribute_Map.AttributeId WHERE CMS_Store_Product_Attribute_Map.ProductId=@ProductId", Product.Schema.Provider.Name);
		...
		public static void SaveAttributeMap(int varProductId, AttributeCollection items)
		{
			QueryCommandCollection coll = new SubSonic.QueryCommandCollection();
			//delete out the existing
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Store_Product_Attribute_Map WHERE ProductId=@ProductId", Product.Schema.Provider.Name);
			cmdDel.AddParameter("@ProductId", varProductId);
			coll.Add(cmdDel);
			DataService.ExecuteTransaction(coll);
...

		{
            ...
            item.CarFrom = varCarFrom;
            
            item.FourWDFrom = varFourWDFrom;
		...
		public struct Columns
		{
             ...
             public static string FourWDFrom = @"FourWDFrom";
