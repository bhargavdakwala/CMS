...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Transaction table.
	/// </summary>
	[Serializable]
	public partial class Transaction : ActiveRecord<Transaction>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Transaction", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarOrderId.DefaultSetting = @"";
					...
					colvarOrderId.ForeignKeyTableName = "CMS_Store_Order";
				...
				colvarTransactionTypeDescriptorId.IsReadOnly = false;
					...
					colvarTransactionTypeDescriptorId.ForeignKeyTableName = "CMS_Store_TransactionTypeDescriptor";
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Transaction",schema);
			}
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.TransactionTypeDescriptor TransactionTypeDescriptor
		{
			get { return Etech.CMS.Store.TransactionTypeDescriptor.FetchByID(this.TransactionTypeDescriptorId); }
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.Order Order
		{
			get { return Etech.CMS.Store.Order.FetchByID(this.OrderId); }
