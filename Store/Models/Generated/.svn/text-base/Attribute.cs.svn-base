...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Attribute table.
	/// </summary>
	[Serializable]
	public partial class Attribute : ActiveRecord<Attribute>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Attribute", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarAttributeTypeId.DefaultSetting = @"";
					...
					colvarAttributeTypeId.ForeignKeyTableName = "CMS_Store_AttributeType";
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Attribute",schema);
			}
		...
		public Etech.CMS.Store.AttributeItemCollection AttributeItemRecords()
		{
			return new Etech.CMS.Store.AttributeItemCollection().Where(AttributeItem.Columns.AttributeId, AttributeId).Load();
		}

		public Etech.CMS.Store.ProductAttributeMapCollection ProductAttributeMapRecords()
		{
			return new Etech.CMS.Store.ProductAttributeMapCollection().Where(ProductAttributeMap.Columns.AttributeId, AttributeId).Load();
		}
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.AttributeType AttributeType
		{
			get { return Etech.CMS.Store.AttributeType.FetchByID(this.AttributeTypeId); }
		...
		public Etech.CMS.Store.ProductCollection GetProductCollection() { return Attribute.GetProductCollection(this.AttributeId); }

		public static Etech.CMS.Store.ProductCollection GetProductCollection(int varAttributeId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Store_Product INNER JOIN CMS_Store_Product_Attribute_Map ON "+
				"CMS_Store_Product.ProductId=CMS_Store_Product_Attribute_Map.ProductId WHERE CMS_Store_Product_Attribute_Map.AttributeId=@AttributeId", Attribute.Schema.Provider.Name);
		...
		public static void SaveProductMap(int varAttributeId, ProductCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Store_Product_Attribute_Map WHERE AttributeId=@AttributeId", Attribute.Schema.Provider.Name);
