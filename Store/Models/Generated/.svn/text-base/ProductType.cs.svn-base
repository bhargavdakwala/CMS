...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_ProductType table.
	/// </summary>
	[Serializable]
	public partial class ProductType : ActiveRecord<ProductType>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_ProductType", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_ProductType",schema);
			}
		...
		{
			return new Etech.CMS.Store.ProductCollection().Where(Product.Columns.ProductTypeId, ProductTypeId).Load();
		}
