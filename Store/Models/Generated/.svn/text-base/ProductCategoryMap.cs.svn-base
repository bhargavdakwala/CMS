...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Product_Category_Map table.
	/// </summary>
	[Serializable]
	public partial class ProductCategoryMap : ActiveRecord<ProductCategoryMap>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Product_Category_Map", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarCategoryId.DefaultSetting = @"";
					...
					colvarCategoryId.ForeignKeyTableName = "CMS_Store_Category";
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Product_Category_Map",schema);
			}
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.Category Category
		{
			get { return Etech.CMS.Store.Category.FetchByID(this.CategoryId); }
