...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Manufacturer table.
	/// </summary>
	[Serializable]
	public partial class Manufacturer : ActiveRecord<Manufacturer>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Manufacturer", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Manufacturer",schema);
			}
		...
		{
			return new Etech.CMS.Store.ProductCollection().Where(Product.Columns.ManufacturerId, ManufacturerId).Load();
		}
