...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Category table.
	/// </summary>
	[Serializable]
	public partial class Category : ActiveRecord<Category>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Category", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Category",schema);
			}
		...
		{
			return new Etech.CMS.Store.ProductCategoryMapCollection().Where(ProductCategoryMap.Columns.CategoryId, CategoryId).Load();
		}
		...
		public Etech.CMS.Store.ProductCollection GetProductCollection() { return Category.GetProductCollection(this.CategoryId); }

		public static Etech.CMS.Store.ProductCollection GetProductCollection(int varCategoryId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Store_Product INNER JOIN CMS_Store_Product_Category_Map ON "+
				"CMS_Store_Product.ProductId=CMS_Store_Product_Category_Map.ProductId WHERE CMS_Store_Product_Category_Map.CategoryId=@CategoryId", Category.Schema.Provider.Name);
		...
		public static void SaveProductMap(int varCategoryId, ProductCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Store_Product_Category_Map WHERE CategoryId=@CategoryId", Category.Schema.Provider.Name);
