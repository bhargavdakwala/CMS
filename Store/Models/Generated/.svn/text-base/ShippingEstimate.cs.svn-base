...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_ShippingEstimate table.
	/// </summary>
	[Serializable]
	public partial class ShippingEstimate : ActiveRecord<ShippingEstimate>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_ShippingEstimate", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_ShippingEstimate",schema);
			}
		...
		{
			return new Etech.CMS.Store.ProductCollection().Where(Product.Columns.ShippingEstimateId, ShippingEstimateId).Load();
		}
