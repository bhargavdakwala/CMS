...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_CustomizedProductDisplayType_Product_Map table.
	/// </summary>
	[Serializable]
	public partial class CustomizedProductDisplayTypeProductMap : ActiveRecord<CustomizedProductDisplayTypeProductMap>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_CustomizedProductDisplayType_Product_Map", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarCustomizedProductDisplayTypeId.DefaultSetting = @"";
					...
					colvarCustomizedProductDisplayTypeId.ForeignKeyTableName = "CMS_Store_CustomizedProductDisplayType";
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_CustomizedProductDisplayType_Product_Map",schema);
			}
