...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_DownloadAccessControl table.
	/// </summary>
	[Serializable]
	public partial class DownloadAccessControl : ActiveRecord<DownloadAccessControl>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_DownloadAccessControl", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarDownloadId.DefaultSetting = @"";
					...
					colvarDownloadId.ForeignKeyTableName = "CMS_Store_Download";
				schema.Columns.Add(colvarDownloadId);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_DownloadAccessControl",schema);
			}
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.Download Download
		{
			get { return Etech.CMS.Store.Download.FetchByID(this.DownloadId); }
