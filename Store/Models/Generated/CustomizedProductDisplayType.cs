...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_CustomizedProductDisplayType table.
	/// </summary>
	[Serializable]
	public partial class CustomizedProductDisplayType : ActiveRecord<CustomizedProductDisplayType>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_CustomizedProductDisplayType", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_CustomizedProductDisplayType",schema);
			}
		...
		{
			return new Etech.CMS.Store.CustomizedProductDisplayTypeProductMapCollection().Where(CustomizedProductDisplayTypeProductMap.Columns.CustomizedProductDisplayTypeId, CustomizedProductDisplayTypeId).Load();
		}
		...
		public Etech.CMS.Store.ProductCollection GetProductCollection() { return CustomizedProductDisplayType.GetProductCollection(this.CustomizedProductDisplayTypeId); }

		public static Etech.CMS.Store.ProductCollection GetProductCollection(int varCustomizedProductDisplayTypeId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Store_Product INNER JOIN CMS_Store_CustomizedProductDisplayType_Product_Map ON "+
				"CMS_Store_Product.ProductId=CMS_Store_CustomizedProductDisplayType_Product_Map.ProductId WHERE CMS_Store_CustomizedProductDisplayType_Product_Map.CustomizedProductDisplayTypeId=@CustomizedProductDisplayTypeId", CustomizedProductDisplayType.Schema.Provider.Name);
		...
		public static void SaveProductMap(int varCustomizedProductDisplayTypeId, ProductCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Store_CustomizedProductDisplayType_Product_Map WHERE CustomizedProductDisplayTypeId=@CustomizedProductDisplayTypeId", CustomizedProductDisplayType.Schema.Provider.Name);
