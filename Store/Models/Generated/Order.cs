...
namespace Etech.CMS.Store
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Store_Order table.
	/// </summary>
	[Serializable]
	public partial class Order : ActiveRecord<Order>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Store_Order", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarOrderStatusDescriptorId.IsReadOnly = false;
					...
					colvarOrderStatusDescriptorId.ForeignKeyTableName = "CMS_Store_OrderStatusDescriptor";
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Store_Order",schema);
			}
		...
		public Etech.CMS.Store.OrderItemCollection OrderItemRecords()
		{
			return new Etech.CMS.Store.OrderItemCollection().Where(OrderItem.Columns.OrderId, OrderId).Load();
		}

		public Etech.CMS.Store.OrderNoteCollection OrderNoteRecords()
		{
			return new Etech.CMS.Store.OrderNoteCollection().Where(OrderNote.Columns.OrderId, OrderId).Load();
		}

		public Etech.CMS.Store.TransactionCollection TransactionRecords()
		{
			return new Etech.CMS.Store.TransactionCollection().Where(Transaction.Columns.OrderId, OrderId).Load();
		}
		...
		/// 
		/// </summary>
		public Etech.CMS.Store.OrderStatusDescriptor OrderStatusDescriptor
		{
			get { return Etech.CMS.Store.OrderStatusDescriptor.FetchByID(this.OrderStatusDescriptorId); }
