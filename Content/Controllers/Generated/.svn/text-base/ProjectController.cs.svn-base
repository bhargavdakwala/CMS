...
namespace Etech.CMS.Content
{
    ...
    public partial class ProjectController
    {
	    ...
	    public void Insert(Guid ProjectGuid,string ProjectTitle,string ProjectDescription,bool? IsActive,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn)
	    {
		    Project item = new Project();
		    
            item.ProjectGuid = ProjectGuid;
	    ...
	    public void Update(int ProjectId,Guid ProjectGuid,string ProjectTitle,string ProjectDescription,bool? IsActive,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn)
	    {
		    Project item = new Project();
	        item.MarkOld();
	        item.IsLoaded = true;
