...
namespace Etech.CMS.Content
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Content_Template table.
	/// </summary>
	[Serializable]
	public partial class Template : ActiveRecord<Template>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Content_Template", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Content_Template",schema);
			}
		...
		{
			return new Etech.CMS.Content.TemplateTemplateRegionMapCollection().Where(TemplateTemplateRegionMap.Columns.TemplateId, TemplateId).Load();
		}
		...
		public Etech.CMS.Content.TemplateRegionCollection GetTemplateRegionCollection() { return Template.GetTemplateRegionCollection(this.TemplateId); }

		public static Etech.CMS.Content.TemplateRegionCollection GetTemplateRegionCollection(int varTemplateId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Content_TemplateRegion INNER JOIN CMS_Content_Template_TemplateRegion_Map ON "+
				"CMS_Content_TemplateRegion.TemplateRegionId=CMS_Content_Template_TemplateRegion_Map.TemplateRegionId WHERE CMS_Content_Template_TemplateRegion_Map.TemplateId=@TemplateId", Template.Schema.Provider.Name);
		...
		public static void SaveTemplateRegionMap(int varTemplateId, TemplateRegionCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Content_Template_TemplateRegion_Map WHERE TemplateId=@TemplateId", Template.Schema.Provider.Name);
