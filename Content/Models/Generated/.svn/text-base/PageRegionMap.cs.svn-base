...
namespace Etech.CMS.Content
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Content_Page_Region_Map table.
	/// </summary>
	[Serializable]
	public partial class PageRegionMap : ActiveRecord<PageRegionMap>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Content_Page_Region_Map", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarRegionId.DefaultSetting = @"";
					...
					colvarRegionId.ForeignKeyTableName = "CMS_Content_Region";
				...
				colvarPageId.DefaultSetting = @"";
					...
					colvarPageId.ForeignKeyTableName = "CMS_Content_Page";
				schema.Columns.Add(colvarPageId);
				
				BaseSchema = schema;
				//add this schema to the provider
				//so we can query it later
				DataService.Providers["CMSProvider"].AddSchema("CMS_Content_Page_Region_Map",schema);
			}
		...
		/// 
		/// </summary>
		public Etech.CMS.Content.Page Page
		{
			get { return Etech.CMS.Content.Page.FetchByID(this.PageId); }
		...
		/// 
		/// </summary>
		public Etech.CMS.Content.Region Region
		{
			get { return Etech.CMS.Content.Region.FetchByID(this.RegionId); }
