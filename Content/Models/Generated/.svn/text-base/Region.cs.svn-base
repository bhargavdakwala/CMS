...
namespace Etech.CMS.Content
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Content_Region table.
	/// </summary>
	[Serializable]
	public partial class Region : ActiveRecord<Region>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Content_Region", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Content_Region",schema);
			}
		...
		{
			return new Etech.CMS.Content.PageRegionMapCollection().Where(PageRegionMap.Columns.RegionId, RegionId).Load();
		}
		...
		public Etech.CMS.Content.PageCollection GetPageCollection() { return Region.GetPageCollection(this.RegionId); }

		public static Etech.CMS.Content.PageCollection GetPageCollection(int varRegionId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Content_Page INNER JOIN CMS_Content_Page_Region_Map ON "+
				"CMS_Content_Page.PageId=CMS_Content_Page_Region_Map.PageId WHERE CMS_Content_Page_Region_Map.RegionId=@RegionId", Region.Schema.Provider.Name);
		...
		public static void SavePageMap(int varRegionId, PageCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Content_Page_Region_Map WHERE RegionId=@RegionId", Region.Schema.Provider.Name);
