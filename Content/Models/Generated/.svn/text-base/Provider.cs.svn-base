...
namespace Etech.CMS.Content
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Content_Provider table.
	/// </summary>
	[Serializable]
	public partial class Provider : ActiveRecord<Provider>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Content_Provider", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Content_Provider",schema);
			}
