...
namespace Etech.CMS.Content
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Content_SimpleHtml table.
	/// </summary>
	[Serializable]
	public partial class SimpleHtml : ActiveRecord<SimpleHtml>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Content_SimpleHtml", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Content_SimpleHtml",schema);
			}
