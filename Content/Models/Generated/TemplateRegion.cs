...
namespace Etech.CMS.Content
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Content_TemplateRegion table.
	/// </summary>
	[Serializable]
	public partial class TemplateRegion : ActiveRecord<TemplateRegion>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Content_TemplateRegion", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Content_TemplateRegion",schema);
			}
		...
		public Etech.CMS.Content.RegionCollection RegionRecords()
		{
			return new Etech.CMS.Content.RegionCollection().Where(Region.Columns.TemplateRegionId, TemplateRegionId).Load();
		}

		public Etech.CMS.Content.TemplateTemplateRegionMapCollection TemplateTemplateRegionMapRecords()
		{
			return new Etech.CMS.Content.TemplateTemplateRegionMapCollection().Where(TemplateTemplateRegionMap.Columns.TemplateRegionId, TemplateRegionId).Load();
		}
		...
		public Etech.CMS.Content.TemplateCollection GetTemplateCollection() { return TemplateRegion.GetTemplateCollection(this.TemplateRegionId); }

		public static Etech.CMS.Content.TemplateCollection GetTemplateCollection(int varTemplateRegionId)
		{
			SubSonic.QueryCommand cmd = new SubSonic.QueryCommand(
				"SELECT * FROM CMS_Content_Template INNER JOIN CMS_Content_Template_TemplateRegion_Map ON "+
				"CMS_Content_Template.TemplateId=CMS_Content_Template_TemplateRegion_Map.TemplateId WHERE CMS_Content_Template_TemplateRegion_Map.TemplateRegionId=@TemplateRegionId", TemplateRegion.Schema.Provider.Name);
		...
		public static void SaveTemplateMap(int varTemplateRegionId, TemplateCollection items)
		{
			...
			QueryCommand cmdDel = new QueryCommand("DELETE FROM CMS_Content_Template_TemplateRegion_Map WHERE TemplateRegionId=@TemplateRegionId", TemplateRegion.Schema.Provider.Name);
