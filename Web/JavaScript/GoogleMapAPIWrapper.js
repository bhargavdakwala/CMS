...
//directions.loadFromWaypoints(polypoints);
    ...
    if (result.ShowDirections) 
    {
        ...
        gdir.load("from: " + result.Directions.FromAddress + " to: " + result.Directions.ToAddress, { "locale": result.Directions.Locale });
    }
}
...
function onGDirectionsLoad() {
    ...
    //var distanceMeter = gdir.getDistance().meters;  // 1609.344;
