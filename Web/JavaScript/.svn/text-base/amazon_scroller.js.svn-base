...
(function(a) {
    a.fn.amazon_scroller = function(p) {
        ...
        //var g=p&&p.scroller_time_interval?p.scroller_time_interval:"8000";
        var g = p && p.scroller_time_interval;
        ...
        function s_s_nav(a, d) {
            ...
            a.children("li").css("width", "16px");
            a.children("li").css("height", "25px");
            a.children("li").css('background-image', 'url("' + d + '/arrow-prev.jpg")');
            //c.css('background-position', 'right top');
            a.children("li:last").css('background-image', 'url("' + d + '/arrow-nxt.jpg")');
            a.children("li").css('background-repeat', 'no-repeat');
            //a.children("li").css('border', "1px solid red")
            c.css('right', '0px')
        }
    }
})(jQuery);