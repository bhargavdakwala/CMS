<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="categoryNavigation.ascx.cs" Inherits="Etech.CMS.Web.controls.categoryNavigation" EnableViewState="false" %>
<asp:Menu runat="server" ID="categoryMenu" Orientation="Vertical" StaticDisplayLevels="3" DataSourceID="xmlDataSource" CssClass="categoryMenu" >
