<%@ Page Title="" Language="C#" MasterPageFile="~/admin/modal.master" AutoEventWireup="true" CodeBehind="BannerSelector.aspx.cs" Inherits="Etech.CMS.Web.admin.BannerSelector" %>
