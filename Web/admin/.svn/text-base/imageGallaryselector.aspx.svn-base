<%@ Page Title="" Language="C#" MasterPageFile="~/admin/modal.master" AutoEventWireup="true" CodeBehind="imageGallaryselector.aspx.cs" Inherits="Etech.CMS.Web.admin.imageGallaryselector" %>
