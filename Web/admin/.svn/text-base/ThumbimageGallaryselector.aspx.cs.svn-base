...
{
    public partial class ThumbimageGallaryselector : Etech.CMS.Store.Web.AdminPage
    {
        #region Constants
        ...
        private const string SITE_IMAGE_PATH = @"~/repository/Gallary/thumbs/";
        private const string GALLERY_IMAGE_THUMB_PATH = @"~/repository/Gallary/thumbs/";
            ...
            try
            {
                ...
                if (file.ContentLength > 0)
                {
                    ...
                    if (SiteSettings.GenerateThumbs)
                    {
                        ...
                        ImageProcess.ResizeAndSave(fuFile.FileContent, fuFile.FileName, HttpContext.Current.Server.MapPath(GALLERY_IMAGE_THUMB_PATH), 134, 56);
                    }
                    LoadImageList();
