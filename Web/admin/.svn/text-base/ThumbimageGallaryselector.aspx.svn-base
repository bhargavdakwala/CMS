<%@ Page Title="" Language="C#" MasterPageFile="~/admin/modal.master" AutoEventWireup="true" CodeBehind="ThumbimageGallaryselector.aspx.cs" Inherits="Etech.CMS.Web.admin.ThumbimageGallaryselector" %>
