...
{
    public partial class MenuTitelImageSelector : Etech.CMS.Store.Web.AdminPage
    {
        #region Constants
            ...
            try
            {
                ...
                if (file.ContentLength > 0)
                {
                    ...
                    if (SiteSettings.GenerateThumbs)
                    {
                        ...
                        ImageProcess.ResizeAndSave(fuFile.FileContent, fuFile.FileName, HttpContext.Current.Server.MapPath(GALLERY_BIG_IMAGE_PATH), 100, 48);
                    }
                    LoadImageList();
