...
{
    public partial class Therapists1 : SiteMasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (imagePath == "")
            {
                imgBanner.Src = ConfigurationManager.AppSettings["siteRoot"].ToString() + "/images/banner02.jpg";
            }
            else
            {
        ...
        {
            int id = Utility.GetIntParameter("mid");
