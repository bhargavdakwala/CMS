<%@ Page Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeBehind="myaccount.aspx.cs" Inherits="Etech.CMS.Web.myaccount" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div id="twoColumnMainContent">
    <div id="site_centercontent">
      <div class="sectionHeader"><CMS:Label ID="lblMyAccount" runat="server" /></div><br />
                ...
                <asp:TabPanel ID="tpUserInfo" runat="server" HeaderText="About" >
                  <ContentTemplate>
                    ...
                    <CMS:Panel ID="pnlChangeEmail" runat="server" Visible="false">
                      ...
                      <CMS:Button ID="btnEmailCancel" runat="server" CssClass="button" CausesValidation="False" OnClick="btnEmailCancel_Click" />&nbsp;
                      <CMS:Button ID="btnEmailSave" runat="server" CssClass="button" OnClick="btnEmailSave_Click" />
                    </CMS:Panel>            
                  </ContentTemplate>
                </asp:TabPanel>
                   ...
                   <CMS:Panel ID="pnlMyOrders" runat="server">
                      <CMS:DataGrid ID="dgOrders" runat="server" AutoGenerateColumns="false" SkinID="adminDataGridNoPage" Width="95%">
                        <Columns>
                          <asp:TemplateColumn>
                            <ItemTemplate>
                              <CMS:LinkButton ID="lbView" runat="server" CommandArgument='<%# Eval("OrderId") %>' OnCommand="lbView_Click" />
                            </ItemTemplate>
                          </asp:TemplateColumn>
