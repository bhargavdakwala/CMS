...
namespace Etech.CMS.Core
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Core_Log table.
	/// </summary>
	[Serializable]
	public partial class Log : ActiveRecord<Log>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Core_Log", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Core_Log",schema);
			}
