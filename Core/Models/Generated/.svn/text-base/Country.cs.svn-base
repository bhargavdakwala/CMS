...
namespace Etech.CMS.Core
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Core_Country table.
	/// </summary>
	[Serializable]
	public partial class Country : ActiveRecord<Country>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Core_Country", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Core_Country",schema);
			}
		...
		public Etech.CMS.Core.StateOrRegionCollection StateOrRegionRecords()
		{
			return new Etech.CMS.Core.StateOrRegionCollection().Where(StateOrRegion.Columns.CountryId, CountryId).Load();
		}
