...
namespace Etech.CMS.Core
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Core_ConfigurationData table.
	/// </summary>
	[Serializable]
	public partial class ConfigurationDatum : ActiveRecord<ConfigurationDatum>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Core_ConfigurationData", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Core_ConfigurationData",schema);
			}
