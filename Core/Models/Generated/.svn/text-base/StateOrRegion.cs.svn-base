...
namespace Etech.CMS.Core
{
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the CMS_Core_StateOrRegion table.
	/// </summary>
	[Serializable]
	public partial class StateOrRegion : ActiveRecord<StateOrRegion>
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("CMS_Core_StateOrRegion", TableType.Table, DataService.GetInstance("CMSProvider"));
				...
				colvarCountryId.DefaultSetting = @"";
					...
					colvarCountryId.ForeignKeyTableName = "CMS_Core_Country";
				...
				DataService.Providers["CMSProvider"].AddSchema("CMS_Core_StateOrRegion",schema);
			}
		...
		/// 
		/// </summary>
		public Etech.CMS.Core.Country Country
		{
			get { return Etech.CMS.Core.Country.FetchByID(this.CountryId); }
